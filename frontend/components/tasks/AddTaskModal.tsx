    ...
    >
      ...
      >
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-slate-500">Create a new task to stay organized</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="min-h-24 w-full resize-none rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:ring-2 focus:ring-slate-300"
              rows={3}
            />
          </div>
